...
+(UIImage *)addFilter:(UIImage *)image tag:(NSInteger)tag{
    if(tag == 0){
        return image;
    }
    ...
    switch (tag) {
        case 1:
            filter = [CIFilter filterWithName:@"CISepiaTone" keysAndValues: kCIInputImageKey, inputImage, nil];
            break;
        case 2:
            filter = [CIFilter filterWithName:@"CIColorPosterize" keysAndValues: kCIInputImageKey, inputImage, nil];
            break;
        case 3:
            filter = [CIFilter filterWithName:@"CIPhotoEffectInstant" keysAndValues: kCIInputImageKey, inputImage, nil];
            break;
        case 4:
            filter = [CIFilter filterWithName:@"CIPhotoEffectNoir" keysAndValues: kCIInputImageKey, inputImage, nil];
            break;
        case 5:
            filter = [CIFilter filterWithName:@"CIPhotoEffectTransfer" keysAndValues: kCIInputImageKey, inputImage , nil];
            break;
        default:
            break;
    }
    ...
    resultImage = [UIImage imageWithCGImage:outputImageRef];
